/*
	这个函数会通过 /proc/self/exe init 来调用自身我们定义的
	initCommand命令，然后给该进程设置隔离信息
*/
...
func setUpMount() error {
	...
	// systemd 加入linux之后， mount namespace 就变成 shared by default, 所以必须显示
	// 声明你要这个新的mount namespace 独立
